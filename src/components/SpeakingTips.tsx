  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 left-6 z-40 bg-white border border-slate-200 p-3 rounded-full shadow-lg hover:shadow-xl hover:bg-slate-50 transition-all group"
        title="Speaking Tips"
      >
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed bottom-20 left-6 z-50 w-[320px] bg-white rounded-2xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.15)] border border-slate-200 overflow-hidden flex flex-col"
            >
